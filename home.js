...
function canWeDeliver (zipCode) {
    for (let i = 0; i < deliveryAreaZipCodes.length; i++){
        if (j === deliveryAreaZipCodes){
        console.log('eligible for delivery')

        } else { 
            console.log('not eligible for delivery')
...
// CODE HERE
canWeDeliver.includes(85205)


function canWeDeliver(deliveryAreaZipCodes) {
  
    if (canWeDeliver.includes(85205)) {
      return 'eligible for delivery'
    } else {
      return 'not eligible for delivery'
    }
